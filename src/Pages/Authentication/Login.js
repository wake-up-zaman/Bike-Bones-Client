        ...
        <div className="card  lg:card-side bg-base-100 shadow-xl ">
            ...
            <div className="cardx w-96  bg-base-100 shadow-xl">
                <div className="card-body card2  pattern items-center text-center">
                    <h2 className="card-title text-3xl card3">Login</h2>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        {signInError}
                        <input className='btn w-full btn-primary text-white mt-5' type="submit" value='Log in' />
                    </form>
                    <label className="label flex justify-end">
                        <p>New to Bike Bones?</p>
                        <Link to='/register'><button className="btn btn-xs ml-6">Register</button></Link>
